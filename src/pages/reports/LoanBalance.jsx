...
const LoanBalance = () => {
  ...
  const [loanBalanceData, loanBalanceDataSet] = useState(null);
          ...
          <div className="print-content p-4">
            <TableContainer className="report-dom">
              <Table size="small" aria-label="a dense table">
                ...
                <TableBody>
                  {loanBalanceData.report.map((reportItem, inx) => (
                    <>
                      <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell style={{ textAlign: "right" }}>
                      {amountFormat(
                        parseFloat(loanBalanceData.totalBalance).toFixed(2)
                      )}
                    </TableCell>
                  </TableRow>
                </TableBody>
  ...
  const getLoanBalance = async () => {
    try {
      ...
      loanBalanceDataSet(response.data);
