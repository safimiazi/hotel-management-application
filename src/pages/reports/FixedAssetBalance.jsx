...
const FixedAssetBalance = () => {
  ...
  const [fixedAssetBalanceData, fixedAssetBalanceDataSet] = useState(null);
          ...
          <div className="print-content p-4">
            <TableContainer className="report-dom">
              <Table size="small" aria-label="a dense table">
                ...
                <TableBody>
                  {fixedAssetBalanceData.report.map((reportItem, inx) => (
                    <>
                      <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell style={{ textAlign: "right" }}>
                      {amountFormat(
                        parseFloat(fixedAssetBalanceData.totalBalance).toFixed(
                          2
                        )
                      )}
                    </TableCell>
  ...
  const getFixedAssetBalance = async () => {
    try {
      loadingSet(true);
      ...
      fixedAssetBalanceDataSet(response.data);
...
export default FixedAssetBalance;
