...
const BarItemSaleReturnInvoice = () => {
        ...
        <div className="">
          ...
          <div>
            <div className="flex flex-col gap-1 mb-4 mt-4">
              <hr />
              <h2 className="text-2xl text-center">BAR SALE RETURN INVOICE</h2>
              <hr />
            </div>
            ...
            <div className="w-full mb-8">
              <TableContainer className="invoice">
                <Table size="small" aria-label="a dense table">
                  ...
                  <TableBody>
                    {invoiceData.itemSalesReturnDetails?.map((item, inx) => (
                      <TableRow>
            ...
            <div className="flex items-start justify-between gap-12">
              ...
              <div className=" flex-1">
                <p className="flex items-center justify-between">
                  ...
                  <span>
                    {parseFloat(
                      invoiceData.itemSalesReturnDetails?.reduce(
                        (prev, curr) => {
...
export default BarItemSaleReturnInvoice;
