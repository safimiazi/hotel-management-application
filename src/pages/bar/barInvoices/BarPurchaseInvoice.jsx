        ...
        <div className="">
          ...
          <div>
            <div className="flex flex-col gap-1 mb-4 mt-4">
              <hr />
              <h2 className="text-2xl text-center">BAR PURCHASE INVOICE</h2>
              <hr />
            </div>
            ...
            <div className="w-full mb-8">
              <TableContainer className="invoice">
                <Table size="small" aria-label="a dense table">
                  ...
                  <TableBody>
                    {invoiceData.itemPurchaseDetails?.map((item, inx) => (
            ...
            <div className="flex items-start justify-between gap-12">
              ...
              <div className=" flex-1">
                <p className="flex items-center justify-between">
                  ...
                  <span>
                    {parseFloat(
                      invoiceData.itemPurchaseDetails?.reduce((prev, curr) => {
                ...
                <p className="flex items-center justify-between">
                  ...
                  <span>
                    {amountFormat(parseFloat(invoiceData.vatAmount).toFixed(2))}
                  </span>
                </p>
                <p className="flex items-center justify-between">
...
export default BarPurchaseInvoice;
