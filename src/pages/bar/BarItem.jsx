...
const BarItem = () => {
  ...
  const [barItemFormData, barItemFormDataSet] = useState({
    code: "",
    name: "",
    saleRate: 0,
    purchaseRate: 0,
  ...
  const handleChange = (event) => {
    ...
    barItemFormDataSet({ ...barItemFormData, [name]: value });
  };
  ...
  const postBarItem = async () => {
    if (barItemFormData.name.trim() === "") {
      Swal.fire({
      ...
      try {
        ...
        if (action == "post") {
          response = await axios.post(`${API_URL}api/v1/BarItem`, barItemData, {
            headers: authHeaders,
          });
        }
        ...
        >
          ...
          <Grid item xs={12} sm={2} md={3}>
            <TextField
              ...
              type="number"
              onKeyDown={handleKeyPress}
              value={barItemFormData.saleRate}
              onChange={(e) => {
                if (0 > e.target.value) {
                  return false;
                }
              ...
              onBlur={(e) => {
                if (e.target.value === "" || parseFloat(e.target.value) < 0) {
                  barItemFormDataSet({ ...barItemFormData, saleRate: 0 });
                }
              }}
          ...
          <Grid item xs={12} sm={2} md={3}>
            <TextField
              ...
              type="number"
              onKeyDown={handleKeyPress}
              value={barItemFormData.purchaseRate}
              onChange={(e) => {
                if (0 > e.target.value) {
                  return false;
                }
              ...
              onBlur={(e) => {
                if (e.target.value === "" || parseFloat(e.target.value) < 0) {
                  barItemFormDataSet({ ...barItemFormData, purchaseRate: 0 });
                }
              }}
          ...
          <Grid item xs={12} sm={2} md={3}>
            <TextField
              ...
              type="number"
              onKeyDown={handleKeyPress}
              value={barItemFormData.openingQty}
              onChange={(e) => {
                if (0 > e.target.value) {
                  return false;
                }
              ...
              onBlur={(e) => {
                if (e.target.value === "" || parseFloat(e.target.value) < 0) {
                  barItemFormDataSet({ ...barItemFormData, openingQty: 0 });
                }
              }}
          ...
          <Grid item xs={12} sm={2} md={3}>
            <TextField
              ...
              type="number"
              onKeyDown={handleKeyPress}
              value={barItemFormData.openingRate}
              onChange={(e) => {
                if (0 > e.target.value) {
                  return false;
                }
              ...
              onBlur={(e) => {
                if (e.target.value === "" || parseFloat(e.target.value) < 0) {
                  barItemFormDataSet({ ...barItemFormData, openingRate: 0 });
                }
              }}
          ...
          <Grid item xs={12} sm={2} md={3}>
            <TextField
              ...
              fullWidth
              onKeyDown={handleKeyPress}
              value={barItemFormData.description}
              onChange={handleChange}
