...
const ItemPurchaseReturnRecord = () => {
        ...
        try {
          if (res.isConfirmed) {
            let response = await axios.delete(
              `${API_URL}api/v1/ItemPurchaseReturn/${row.id}`,
              { headers: authHeaders },
              { id: row.id }
            );
            Swal.fire({
            ...
            <div className="print-content p-4">
              <TableContainer className="report-dom">
                <Table size="small" aria-label="a dense table">
                  ...
                  <TableBody>
                    {purchaseData.map((purchaseReturnItem, inx) => (
                      <>
                        <TableRow>
                          ...
                          <TableCell style={{ textAlign: "left" }}>
                            {purchaseReturnItem.invoiceNo}
                          </TableCell>
                          <TableCell style={{ textAlign: "left" }}>
                            {purchaseReturnItem.supplier.name}
                          </TableCell>
                          <TableCell style={{ textAlign: "left" }}>
                            {dayjs(purchaseReturnItem.createdDate).format(
                              dateFormat
                            )}
                          </TableCell>
                          <TableCell style={{ textAlign: "left" }}>
                            {purchaseReturnItem.creator?.userName}
                          </TableCell>
                          <TableCell style={{ textAlign: "left" }}>
                            {purchaseReturnItem.updater?.userName}
                          </TableCell>

                          <TableCell style={{ textAlign: "left" }}>
                            {
                              purchaseReturnItem.itemPurchaseReturnDetails[0]
                                .item.name
                            }
                          </TableCell>
                          ...
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
                              parseFloat(
                                purchaseReturnItem.totalAmount
                              ).toFixed(2)
                            )}
                          </TableCell>
                          <TableCell
                          ...
                          >
                            <div className="flex items-center gap-3 justify-around">
                              <Link
                                to={{
                                  pathname: `/purchase/item-purchase-return-invoice/${purchaseReturnItem.id}`,
                                }}
                              >
                                <ReceiptIcon
                                  style={{
                              ...
                              <Link
                                to={{
                                  pathname: `/purchase/purchase-return/${purchaseReturnItem.id}`,
                                }}
                              >
                                <EditNoteIcon
                                  style={{
                              ...
                              <DeleteForeverIcon
                                ...
                                onClick={() => handleDelete(purchaseReturnItem)}
                              />
                            </div>
                          </TableCell>
                        </TableRow>

                        {purchaseReturnItem.itemPurchaseReturnDetails
                          .slice(1)
                          .map((detail) => (
                            <TableRow>
                    ...
                    {purchaseData.map((purchaseReturnItem, inx) => (
                      <>
                        <TableRow>
                          ...
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
                              parseFloat(purchaseReturnItem.dueAmount).toFixed(
                                2
                              )
                            )}
                          </TableCell>
                          ...
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
                              parseFloat(
                                purchaseReturnItem.othersCharge
                              ).toFixed(2)
                            )}
                          </TableCell>
                          ...
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
                              parseFloat(purchaseReturnItem.vatAmount).toFixed(
                                2
                              )
                            )}
                          </TableCell>
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
                              parseFloat(purchaseReturnItem.paidAmount).toFixed(
                                2
                              )
                            )}
                          </TableCell>
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
                              parseFloat(purchaseReturnItem.subTotal).toFixed(2)
                            )}
                          </TableCell>
                          <TableCell style={{ textAlign: "right" }}>
                            {amountFormat(
...
export default ItemPurchaseReturnRecord;
