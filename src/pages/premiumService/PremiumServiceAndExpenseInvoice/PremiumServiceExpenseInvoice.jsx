...
const PremiumServiceExpenseInvoice = () => {
        ...
        <div className="">
          ...
          <div>
            <div className="flex flex-col gap-1 mb-4 mt-4">
              <hr />
              <h2 className="text-2xl text-center">SERVICE EXPENSE INVOICE</h2>
              <hr />
            </div>
            ...
            <div className="w-full mb-8">
              <TableContainer className="invoice">
                <Table size="small" aria-label="a dense table">
                  ...
                  <TableBody>
                    {invoiceData.expenseDetails?.map((item, inx) => (
                      <TableRow>
                        ...
                        <TableCell style={{ textAlign: "right" }}>
                          {amountFormat(parseFloat(item.cost).toFixed(2))}
                        </TableCell>
                        <TableCell style={{ textAlign: "right" }}>
                          {item.qty}
                        </TableCell>
            ...
            <div className="flex items-start justify-between gap-12">
              ...
              <div className=" flex-1">
                <p className="flex items-center justify-between">
                  ...
                  <span>
                    {parseFloat(
                      invoiceData.expenseDetails?.reduce((prev, curr) => {
...
export default PremiumServiceExpenseInvoice;
