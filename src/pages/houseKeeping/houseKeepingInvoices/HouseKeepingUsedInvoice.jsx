              ...
              <div className="flex justify-between items-center mb-3">
                <div className="space-y-1">
                  <p className="mt-2">
                    ...
                    <span>{invoiceData.floor?.floorNo}</span>
                  </p>
                  <p>
                    <span className="font-bold">Room Name: </span>{" "}
                    <span>{invoiceData.room?.roomNo}</span>
                  </p>
                </div>
              ...
              <div className="w-full mb-8">
                <TableContainer className="invoice">
                  <Table size="small" aria-label="a dense table">
                    ...
                    <TableBody>
                      {invoiceData.itemUsedDetails?.map((item, inx) => (
                        <TableRow>
              ...
              <div className="flex items-start justify-between gap-12">
                ...
                <div className=" flex-1">
                  <p className="flex items-center justify-between">
                    ...
                    <span>
                      {parseFloat(
                        invoiceData.itemUsedDetails?.reduce((prev, curr) => {
                  ...
                  <p className="flex items-center justify-between">
                    ...
                    <span>
                      {amountFormat(
                        parseFloat(invoiceData.othersCharge).toFixed(2)
                      )}
                    </span>
                  </p>
                  ...
                  <p className="flex items-center justify-between">
                    ...
                    <span>
                      {amountFormat(
                        parseFloat(invoiceData.totalCost).toFixed(2)
                      )}
                    </span>
                  </p>
                </div>
...
export default HouseKeepingUsedInvoice;
