import {
  ...
  const SupplierTransactionInvoice = () => {
          ...
          <div className="">
            ...
            <div>
              <div className="flex flex-col gap-1 mb-4 mt-4">
                <hr />
                <h2 className="text-2xl text-center uppercase">{`SUPPLIER ${invoiceData?.transactionType && invoiceData?.transactionType}`}</h2>
                <hr />
              </div>
              ...
              <div className="flex justify-between items-center mb-3">
                <div className="space-y-1">
                  ...
                  <p>
                    <span className="font-bold">Supplier Contact No: </span>{" "}
              ...
              <div className="w-full mb-8">
                <TableContainer className="invoice">
                  <Table size="small" aria-label="a dense table">
                    ...
                    <TableBody>
                      {invoiceData.supplierTransactionDetails?.map(
                        (item, inx) => (
                          <TableRow>
  ...
  export default SupplierTransactionInvoice;
