          ...
          <div className="">
            ...
            <div>
              <div className="flex flex-col gap-1 mb-4 mt-4">
                <hr />
                <h2 className="text-2xl text-center uppercase">{`CUSTOMER ${invoiceData?.transactionType && invoiceData?.transactionType}`}</h2>
                <hr />
              </div>
              ...
              <div className="w-full mb-8">
                <TableContainer className="invoice">
                  <Table size="small" aria-label="a dense table">
                    ...
                    <TableBody>
                      {invoiceData.customerTransactionDetails?.map(
                        (item, inx) => (
                          <TableRow>
