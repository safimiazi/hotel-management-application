  ...
  const getInvoiceData = async () => {
    try {
      const response = await axios.get(
        `${API_URL}api/v1/ItemSales/${pathSplitter(location.pathname, 2)}`,
        {
          headers: authHeaders,
        }
      );
        ...
        <div className="">
          ...
          <div>
            <div className="flex flex-col gap-1 mb-4 mt-4">
              <hr />
              <h2 className="text-2xl text-center">SALES INVOICE</h2>
              <hr />
            </div>
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <div className="text-right space-y-1">
                ...
                <p>
                  <span className="font-bold">Sales Date: </span>{" "}
                  <span>
                    {dayjs(invoiceData?.createdDate).format(dateFormat)}
                  </span>
                </p>
                <p>
                  <span className="font-bold">Sales By: </span>{" "}
            ...
            <div className="w-full mb-8">
              <TableContainer className="invoice">
                <Table size="small" aria-label="a dense table">
                  ...
                  <TableBody>
                    {invoiceData.itemSalesDetails?.map((item, inx) => (
                      <TableRow>
            ...
            <div className="flex items-start justify-between gap-12">
              ...
              <div className=" flex-1">
                <p className="flex items-center justify-between">
                  ...
                  <span>
                    {parseFloat(
                      invoiceData.itemSalesDetails?.reduce((prev, curr) => {
